      ...
      <table class="table" style='width: 4000px;'>
       ...
       <?php foreach($orders as $k => $v): ?>
        <tr>
         ...
         <td class="center"><?php print $v['gmt_payment']; ?></td>
         <td class="center"><?php print $v['buyer_pay_amount']; ?></td>
         <td class="center"><?php print $v['receipt_amount']; ?></td>
         <td class="center"><?php print $v['out_trade_no']; ?></td>
         <td class="center"><?php print $v['trade_no']; ?></td>
         <td class="center">
