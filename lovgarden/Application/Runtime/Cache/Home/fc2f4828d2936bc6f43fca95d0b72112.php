...
<div id="my-cart-detail-info">
  ...
  <div id="mobile-menu-section">
   ...
   <div class="flow3-background">
     <div class="flow3-success-message">
       <p><span class="glyphicon glyphicon-ok ok-icon"></span><?php print translate_status_label($status); ?></p>
       <p><a href="/">返回首页</a></p>
     </div>
     <img src="/Public/Home/images/flow/checkout_success_background.jpg" style="width: 100%;">
   </div>
