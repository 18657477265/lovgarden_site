...
<head>
     ...
     <link rel="stylesheet" href="/Public/Home/css/jquery.confirm-1.1.css">
     ...
     <script src="/Public/Home/js/jquery.confirm-1.1.js"></script>
...
<body class="page order-flow1">
  ...
  <form id="review-order" class="submit-order-form" method="post" action="/cart/detail">
