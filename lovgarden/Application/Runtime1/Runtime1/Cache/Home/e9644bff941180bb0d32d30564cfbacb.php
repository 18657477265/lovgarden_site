...
<head>
     ...
     <link rel="stylesheet" href="/Public/Home/css/city-picker.css">
...
<body class="page">
  ...
  <div class="container-fluid flow-top-banner">
    ...
    <div class="page-header page-header--checkout col-md-10 col-sm-8 col-xs-6">
      <div class="page-header__logo">
          <a rel="home" class="page-header__logo-link" href="/"><img src="/Public/Home/images/lovgarden_logo.png" /></a>
      </div>
    </div>
    <div class="col-md-1 col-sm-2 col-xs-3 checkout-help-link">
       <a class="utility-nav__item-node" href="/article/helpcenter">帮助中心</a>
    </div>
  </div>
  ...
  <div class="container checkout-order-content">
    ...
    <form class="container deliver-info-form" action="/cart/checkout.html" method="POST" id="order_submit_confirm">
  ...
  <div class="flow-checkout-footer">
    ...
    <!--<script src="/Public/Home/js/validatr.js"></script>-->
    <script>
