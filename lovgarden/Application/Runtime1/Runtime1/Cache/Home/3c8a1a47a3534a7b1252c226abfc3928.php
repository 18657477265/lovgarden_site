...
<head>
     ...
     <title><?php print $faq['article_title']; ?>|花点馨思(丽de花苑)</title>
...
<div id="my-cart-detail-info">
  ...
  <!-- 左边黑框描述，右边图片block样式-->
   ...
   <div class="category-banner-content-block container">
      ...
      <div class="category-banner-content-block__content col-md-3 col-sm-4">
          <h1 class="category-banner-content-block__title"><?php print $faq['article_title']; ?></h1>
          <p class="category-banner-content-block__description"><?php print $faq['article_summary']; ?></p>
      </div>
      <div class="category-banner-content-block__image col-md-9 col-sm-8" style="background-image: url(<?php echo C('IMAGE_CONFIG')['viewPath'].$faq['banner_image']; ?>)">
        
      </div>
      </div>
   </div>
   <div class="container pagination-results">
       <div class="section-tree" style="margin-top: 20px;">        
        <?php print $faq['article_body']; ?>
      </div>      
  </div>
  ...
  <div class="pagination-results container">
  	...
  	<ul class="product-grid">
          <?php foreach($products as $sku_id => $product_varient): ?>
	  <li class="product-grid__cell col-md-4 col-sm-4 col-xs-12 list-grid-left">
		<div class="product-summary">
		    <div class="product-summary__media">
                        <a class="product-summary__media-link" href='/product/show/sku_id/<?php print $sku_id; ?>'><img title="<?php print $product_varient['varient_name']; ?>" alt="<?php print $product_varient['varient_name']; ?>" src="<?php print C('IMAGE_CONFIG')['viewPath'].$product_varient['image_url'][0] ?>"></a>
		    </div>
  ...
  <p class="products-read-more"><a class="read-more" href="/product/select_list">查看更多</a></p>
  <?php endif; ?>
